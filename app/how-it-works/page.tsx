...
const content = {
  en: {
    ...
    steps: [
      ...
      ["04", "→", "Enter the retailer’s storefront", "Open /store/[slug], choose products, and complete the order directly with that business."],
    ],
    ...
    rowFour: ["Store opens directly", "Existing /store/[slug] route"],
