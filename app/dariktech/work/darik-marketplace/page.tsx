...
const modules = [
  ...
  },
  {
    ...
    text: "Retailer screening, Add New Product, approval workflow, official photo lock, inventory status, ads, CliQ balance, receipts, and support tickets.",
    icon: "store",
    visual: "retailer",
  },
  {
  ...
  {
    title: "Finance & Trust",
    text: "Cleared CliQ, pending payouts, 24-hour clearing, balance receipts, ad fees, fulfillment fees, return credits, and Profit & Loss tracking.",
    icon: "chat",
    visual: "finance",
  },
];
...
const includes = [
  ...
  ["Retailer Money & Ads", "Cleared CliQ payment, pending CliQ payout, balance receipts, payout ledger, paid ad requests, current live ads, and ad performance insights."],
...
const includeBadges = [
  ...
  ["Cleared CliQ", "Paid Ads", "Receipts"],
...
const previews = [
  ...
  },
  {
    ...
    text: "Retailer dashboard, Add New Product, official photo approval, inventory status, ads, CliQ balance, receipts, and support tickets.",
    type: "retailer",
...
function ModuleMiniScreen({ type }: { type: string }) {
  ...
  return (
    <div className="dm-module-screen dm-module-finance-screen">
      <div className="dm-module-screen-top"><strong>Finance & Trust</strong><span>CliQ</span></div>
      <div className="dm-module-money-card"><b>Cleared CliQ</b><span>Ready to pay</span></div>
      <div className="dm-module-money-card muted"><b>Pending CliQ</b><span>24-hour rule</span></div>
    ...
    return (
      <div className="dm-phone-screen dm-action-screen dm-action-customer">
        ...
        <div className="dm-action-product-grid">
          <div><i /><b /><span>31.25 JOD</span></div>
          <div><i /><b /><span>6.25 JOD</span></div>
        </div>

        <div className="dm-action-delivery-choice">
          <div><b>Free Next-Day</b><span>0 JOD</span></div>
          <div><b>Express</b><span>2 JOD</span></div>
        </div>
    ...
    return (
      <div className="dm-phone-screen dm-action-screen dm-action-retailer">
        ...
        <div className="dm-action-money-row">
          <div><small>Cleared CliQ</small><b>Ready</b></div>
          <div><small>Pending CliQ</small><b>24h</b></div>
        </div>
  ...
  return (
    <main className="dm-page">
      <style>{`
        ...
        /* Mobile-only ChatGPT signature polish: scanlines, live data, and premium motion */
          ...
          <div className="dm-laptop dm-real-admin-laptop">
            <div className="dm-laptop-screen dm-real-admin-screen">
              ...
              <div className="dm-real-kpi-grid">
                ...
                <div className="dm-real-kpi"><span>Cleared CliQ</span><strong>24h</strong><small>Retailer payout rule</small></div>
            ...
            <div className="dm-system-grid">
              ...
              <div className="dm-system-flow dm-system-flow-expanded" aria-label="Darik connected marketplace ecosystem">
                ...
                <article className="dm-flow-node dm-flow-retailer">
                  ...
                  <span>Products, inventory, ads, receipts, and CliQ payouts.</span>
                </article>
