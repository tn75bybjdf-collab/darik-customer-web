    ...
    <main className="mw-page" data-smart-lang="en">
      <style>{`
        ...
        .mw-location-card {
          ...
          background:
            radial-gradient(circle at 88% 10%, rgba(98, 214, 255, 0.15), transparent 14rem),
        ...
        .mw-location-card:hover {
          ...
          background:
            radial-gradient(circle at 88% 10%, rgba(98, 214, 255, 0.22), transparent 14rem),
        ...
        .mw-location-dubai {
          ...
          background:
            radial-gradient(circle at 88% 10%, rgba(255, 216, 61, 0.14), transparent 14rem),
            linear-gradient(180deg, rgba(255, 255, 255, 0.09), rgba(255, 255, 255, 0.034));
        }

        .mw-location-dubai:hover {
          border-color: rgba(255, 216, 61, 0.38);
          background:
            radial-gradient(circle at 88% 10%, rgba(255, 216, 61, 0.22), transparent 14rem),
            linear-gradient(180deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.045));
        }
        ...
        .mw-location-arabic {
          ...
          background:
            radial-gradient(circle at 88% 10%, rgba(124, 92, 255, 0.18), transparent 14rem),
            linear-gradient(180deg, rgba(255, 255, 255, 0.09), rgba(255, 255, 255, 0.034));
        }

        .mw-location-card-top span {
          display: inline-flex;
          width: max-content;
          margin-bottom: 14px;
          border-radius: 999px;
        ...
        .mw-location-dubai .mw-location-card-top span {
          color: #ffd83d;
        }

        .mw-location-arabic .mw-location-card-top span {
          color: #c4b5fd;
        }

        .mw-location-card-top strong {
          display: block;
          color: #ffffff;
...
<nav className="mw-nav">
      ...
      <section className="mw-section mw-location-section" id="locations">
        <div className="mw-shell">
          <div className="mw-section-head mw-location-head">
            <h2>App development pages for Jordan and Dubai.</h2>
            <p>
              If someone finds this service page while comparing app developers,
              these focused landing pages help them choose the right market and
              help Google understand where Darik Technologies offers business
              app development.
            </p>
          ...
          <div className="mw-location-grid">
            <a className="mw-location-card mw-location-jordan" href="/dariktech/app-developer-jordan">
              <div className="mw-location-card-top">
                <span>Jordan</span>
                <strong>App Developer in Jordan</strong>
              </div>
              <p>
                Mobile apps, web apps, admin dashboards, marketplaces, and
                backend systems for Jordan-based businesses.
              </p>
              <div className="mw-location-tags">
                <span>app developer Jordan</span>
                <span>mobile apps</span>
                <span>admin dashboards</span>
              </div>
              <b>Open Jordan SEO page →</b>
            </a>

            <a className="mw-location-card mw-location-dubai" href="/dariktech/app-developer-dubai">
              <div className="mw-location-card-top">
                <span>Dubai</span>
                <strong>App Developer in Dubai</strong>
              </div>
              <p>
                Mobile apps, web portals, marketplace platforms, admin systems,
                and custom business software for Dubai and UAE-focused
                companies.
              </p>
              <div className="mw-location-tags">
              ...
              <b>Open Dubai SEO page →</b>
            </a>

            <a className="mw-location-card mw-location-arabic" href="/ar/dariktech/app-developer-jordan">
              <div className="mw-location-card-top">
                <span>Arabic</span>
                <strong>تطوير تطبيقات في الأردن</strong>
              </div>
              <p>
                صفحة عربية مخصصة للشركات التي تبحث عن تطوير تطبيقات جوال،
                تطبيقات أعمال، لوحات تحكم، وأسواق رقمية في الأردن.
              </p>
              <div className="mw-location-tags">
                <span>شركة تطوير تطبيقات في الأردن</span>
                <span>تطبيقات أعمال</span>
              </div>
              <b>Open Arabic Jordan page →</b>
            </a>

            <a className="mw-location-card mw-location-arabic" href="/ar/dariktech/app-developer-dubai">
              <div className="mw-location-card-top">
                <span>Arabic</span>
                <strong>تطوير تطبيقات في دبي</strong>
              </div>
              <p>
                صفحة عربية مخصصة للشركات التي تستهدف دبي والإمارات وتحتاج
                تطبيقات جوال، بوابات ويب، ولوحات تحكم.
              </p>
              <div className="mw-location-tags">
                <span>شركة تطوير تطبيقات في دبي</span>
                <span>تطبيقات جوال</span>
              </div>
              <b>Open Arabic Dubai page →</b>
            </a>
          </div>
        </div>
      </section>
