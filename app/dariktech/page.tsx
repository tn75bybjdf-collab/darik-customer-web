    ...
    <main className="dt-page" data-smart-lang="en">
      <style>{`
        ...
        .dt-location-card {
          ...
          border: 1px solid rgba(98, 214, 255, 0.16);
          background:
            radial-gradient(circle at 88% 12%, rgba(98, 214, 255, 0.16), transparent 18rem),
            linear-gradient(180deg, rgba(255, 255, 255, 0.095), rgba(255, 255, 255, 0.035)),
            rgba(255, 255, 255, 0.055);
          color: #f7fbff;
          text-decoration: none;
        ...
        .dt-location-card:hover {
          ...
          border-color: rgba(98, 214, 255, 0.38);
          background:
            radial-gradient(circle at 88% 12%, rgba(98, 214, 255, 0.23), transparent 18rem),
        ...
        .dt-location-dubai {
          ...
          background:
            radial-gradient(circle at 88% 12%, rgba(255, 216, 61, 0.16), transparent 18rem),
            linear-gradient(180deg, rgba(255, 255, 255, 0.095), rgba(255, 255, 255, 0.035)),
            rgba(255, 255, 255, 0.055);
        }

        .dt-location-dubai:hover {
          border-color: rgba(255, 216, 61, 0.38);
          background:
            radial-gradient(circle at 88% 12%, rgba(255, 216, 61, 0.23), transparent 18rem),
            linear-gradient(180deg, rgba(255, 255, 255, 0.12), rgba(255, 255, 255, 0.045)),
            rgba(255, 255, 255, 0.07);
        }

        .dt-location-card-top {
          display: flex;
          align-items: center;
          justify-content: space-between;
          gap: 14px;
        ...
        .dt-location-dubai .dt-location-card-top strong {
          color: #ffd83d;
        }
        ...
        .dt-location-keywords {
          display: flex;
          flex-wrap: wrap;
          gap: 8px;
        }

        .dt-location-keywords span {
          border-radius: 999px;
          border: 1px solid rgba(255, 255, 255, 0.11);
          background: rgba(255, 255, 255, 0.075);
          color: rgba(247, 251, 255, 0.72);
        ...
        .dt-location-dubai .dt-location-link {
          color: #ffd83d;
        }
...
<div className="dt-grid-bg" aria-hidden="true" />
      ...
      <section className="dt-section dt-location-section" id="locations">
        <div className="dt-shell">
          <div className="dt-section-head dt-location-head">
            <div>
              <span className="dt-eyebrow">App development locations</span>
              <h2>Landing pages for people searching in Jordan and Dubai.</h2>
            </div>
            <p>
              These pages help Google understand that Darik Technologies builds
              mobile apps, web apps, marketplaces, admin dashboards, and backend
              systems for businesses in Jordan, Dubai, and the wider region.
            </p>
          </div>

          <div className="dt-location-grid">
            <a className="dt-location-card dt-location-jordan" href="/dariktech/app-developer-jordan">
              <div className="dt-location-card-top">
                <span>Jordan SEO page</span>
                <strong>01</strong>
              </div>
              <h3>App Developer in Jordan</h3>
              <p>
                A focused page for app development in Jordan, mobile app
                development in Amman, business apps, marketplaces, dashboards,
                and backend systems.
              </p>
              <div className="dt-location-keywords">
                <span>app developer Jordan</span>
                <span>mobile app developer Jordan</span>
                <span>admin dashboards</span>
              </div>
              <strong className="dt-location-link">Open Jordan page →</strong>
            </a>

            <a className="dt-location-card dt-location-dubai" href="/dariktech/app-developer-dubai">
              <div className="dt-location-card-top">
                <span>Dubai SEO page</span>
                <strong>02</strong>
              </div>
              <h3>App Developer in Dubai</h3>
              <p>
                A focused page for Dubai and UAE businesses looking for mobile
                apps, web apps, marketplaces, admin systems, and custom business
                software.
              </p>
              <div className="dt-location-keywords">
              ...
              <strong className="dt-location-link">Open Dubai page →</strong>
            </a>
          </div>

          <div className="dt-location-note">
            <strong>Why this matters for Google</strong>
            <p>
              These internal links make the new SEO pages part of the real site
              structure. That helps search engines discover the pages and
              understand which services and markets Darik Technologies targets.
            </p>
          </div>
        </div>
      </section>
